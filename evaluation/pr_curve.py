...
macros = { # folder, label, colour.
    ...
    # 3: ['initial_06', '06', 'pink'],
    # 4: ['initial_07', '07', 'teal'],
    # 5: ['initial_08', '08', 'yellow'],
    0: ['initial_06', '06', 'green']
}
...
if introspect:
    ...
    table1 = ax1.table(cellText=F1data, rowLabels=rows, colLabels=F1columns, loc='center')
    table1.scale(0.7,2)
    ax1.axis('off')
    ax2 = fig.add_subplot(2,1,2)
    table2 = ax2.table(cellText=EPdata, rowLabels=rows, colLabels=EPcolumns, loc='center')
    table2.scale(0.7,2)
    ax2.axis('off')
